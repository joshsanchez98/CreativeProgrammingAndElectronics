...
**Challenges:**
- Getting the processing.video to work.  I needed to find a way to connect my webcam to my Processing code, but connection was not able to be made because of technical difficulties. *Therefore, I ended up importing video instead of using webcam for the time being.*  So, to still incorporate video, I made sure that I knew how to use and play a clip here in this example. I was using Mac OS Mojave Version 10.14.6; a recent version did not work correctly on the Mac and ended up trying the the following sources:
